...
#define EC_WORD_I_LOVE_YOU      ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 42)
#define EC_WORD_I_MISS_YOU      ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 43)
#define EC_WORD_SUCH            ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 44)
#define EC_WORD_MARRY           ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 45)
#define EC_WORD_WILL_YOU        ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 46)
#define EC_WORD_FUCK_YOU        ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 47)
#define EC_WORD_FUCK_OFF        ((EC_GROUP_GREETINGS << EC_MASK_BITS) | 48)
...
#define EC_WORD_MAY          ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 75)
#define EC_WORD_BRENDAN      ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 76)
#define EC_WORD_HONEY        ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 77)
#define EC_WORD_SLUT         ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 78)
#define EC_WORD_BASTARD      ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 79)
#define EC_WORD_BITCH        ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 80)
#define EC_WORD_DUMBASS      ((EC_GROUP_PEOPLE << EC_MASK_BITS) | 81)
...
#define EC_WORD_FUCK                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 63)
#define EC_WORD_SHIT                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 64)
#define EC_WORD_ASS                         ((EC_GROUP_VOICES << EC_MASK_BITS) | 65)
#define EC_WORD_BULLSHIT                    ((EC_GROUP_VOICES << EC_MASK_BITS) | 66)
#define EC_WORD_PUSSY                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 67)
#define EC_WORD_COCK                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 68)
#define EC_WORD_DICK                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 69)
#define EC_WORD_LICK                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 70)
#define EC_WORD_CUM                         ((EC_GROUP_VOICES << EC_MASK_BITS) | 71)
#define EC_WORD_CUMS                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 72)
#define EC_WORD_FUCKING                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 73)
#define EC_WORD_FUCKED                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 74)
#define EC_WORD_FUCKS                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 75)
#define EC_WORD_SUCK                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 76)
#define EC_WORD_SUCKS                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 77)
#define EC_WORD_SUCKING                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 78)
#define EC_WORD_SUCKED                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 79)
#define EC_WORD_LICKS                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 80)
#define EC_WORD_LICKING                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 81)
#define EC_WORD_LICKED                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 82)
#define EC_WORD_CUMMING                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 83)
#define EC_WORD_CUMMED                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 84)
#define EC_WORD_ASSHOLE                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 85)
#define EC_WORD_ORGASM                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 86)
#define EC_WORD_ORGASMS                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 87)
#define EC_WORD_MASTURBATION                ((EC_GROUP_VOICES << EC_MASK_BITS) | 88)
#define EC_WORD_MASTURBATE                  ((EC_GROUP_VOICES << EC_MASK_BITS) | 89)
#define EC_WORD_MASTURBATES                 ((EC_GROUP_VOICES << EC_MASK_BITS) | 90)
#define EC_WORD_MASTURBATING                ((EC_GROUP_VOICES << EC_MASK_BITS) | 91)
#define EC_WORD_MASTURBATED                 ((EC_GROUP_VOICES << EC_MASK_BITS) | 92)
#define EC_WORD_PUSSYLICKER                 ((EC_GROUP_VOICES << EC_MASK_BITS) | 93)
#define EC_WORD_SEMEN                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 94)
#define EC_WORD_SEX                         ((EC_GROUP_VOICES << EC_MASK_BITS) | 95)
#define EC_WORD_SEXUAL                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 96)
#define EC_WORD_SEXUALITY                   ((EC_GROUP_VOICES << EC_MASK_BITS) | 97)
#define EC_WORD_SEXUALIZE                   ((EC_GROUP_VOICES << EC_MASK_BITS) | 98)
#define EC_WORD_SEXUALIZED                  ((EC_GROUP_VOICES << EC_MASK_BITS) | 99)
#define EC_WORD_SEXY                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 100)
#define EC_WORD_SEXIEST                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 101)
#define EC_WORD_DICKRIDER                   ((EC_GROUP_VOICES << EC_MASK_BITS) | 102)
#define EC_WORD_COCKSUCKER                  ((EC_GROUP_VOICES << EC_MASK_BITS) | 103)
#define EC_WORD_CHICK                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 104)
#define EC_WORD_CHICKS                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 105)
#define EC_WORD_CUCK                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 106)
#define EC_WORD_CUCKOLD                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 107)
#define EC_WORD_CUCKED                      ((EC_GROUP_VOICES << EC_MASK_BITS) | 108)
#define EC_WORD_HOLY                        ((EC_GROUP_VOICES << EC_MASK_BITS) | 109)
#define EC_WORD_PENIS                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 110)
#define EC_WORD_DICKS                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 111)
#define EC_WORD_PENISES                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 112)
#define EC_WORD_PUSSIES                     ((EC_GROUP_VOICES << EC_MASK_BITS) | 113)
#define EC_WORD_ASSES                       ((EC_GROUP_VOICES << EC_MASK_BITS) | 114)
...
#define EC_WORD_DRUG           ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 69)
#define EC_WORD_DRUGS          ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 70)
#define EC_WORD_CARTEL         ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 71)
#define EC_WORD_NIGGA          ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 72)
#define EC_WORD_NIGGER         ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 73)
#define EC_WORD_NIGGAS         ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 74)
#define EC_WORD_NIGGERS        ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 75)
#define EC_WORD_PAJEET         ((EC_GROUP_ENDINGS << EC_MASK_BITS) | 76)
...
#define EC_WORD_KILL       ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 78)
#define EC_WORD_GENOCIDE   ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 79)
#define EC_WORD_MIDDLE_FINGER ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 80)
#define EC_WORD_FINGER    ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 81)
#define EC_WORD_FINGERED   ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 82)
#define EC_WORD_FINGERING ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 83)
#define EC_WORD_BIG_BLACK ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 84)
#define EC_WORD_STROKE ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 85)
#define EC_WORD_STROKED ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 86)
#define EC_WORD_STROKING ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 87)
#define EC_WORD_STROKES ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 88)
#define EC_WORD_SLAP ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 89)
#define EC_WORD_SLAPPED ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 90)
#define EC_WORD_SLAPPING ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 91)
#define EC_WORD_SLAPS ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 92)
#define EC_WORD_TUFF ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 93)
#define EC_WORD_GNG ((EC_GROUP_ACTIONS << EC_MASK_BITS) | 94)
